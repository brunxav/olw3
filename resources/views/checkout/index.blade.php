        ...
        <div class="relative mx-auto grid max-w-7xl grid-cols-1 gap-x-16 lg:grid-cols-2 lg:px-8 lg:pt-16">
            ...
            <section aria-labelledby="payment-and-shipping-heading"
                ...
                <form>
                    <div class="mx-auto max-w-2xl px-4 lg:max-w-none lg:px-0">
                        <div>
                            <h3 id="contact-info-heading" class="text-lg font-medium text-white">Informação de contato
                            </h3>

                            <div class="mt-6">
                                <label for="email-address" class="block text-sm font-medium text-white">Email
                                    address</label>
                                <div class="mt-1">
                        ...
                        <div class="mt-10">
                            ...
                            <div class="mt-6 grid grid-cols-3 gap-x-4 gap-y-6 sm:grid-cols-4">
                                <div class="col-span-3 sm:col-span-4">
                                    <label for="card-number" class="block text-sm font-medium text-white">Numero do
                                        cartao</label>
                                    <div class="mt-1">
                                ...
                                <div class="col-span-2 sm:col-span-3">
                                    <label for="expiration-date" class="block text-sm font-medium text-white">Data de
                                        expiração (MM/YY)</label>
                                    <div class="mt-1">
